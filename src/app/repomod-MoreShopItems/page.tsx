          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 flex items-center">
                ...
                <span className="ml-3 text-sm bg-amber-700 px-2 py-1 rounded-full">v1.2.5</span>
              </h1>
              
              <div className="flex items-center mb-6 text-gray-400">
                <FiCalendar className="mr-2" />
                <span>Last updated: April 12, 2023</span>
              </div>
            ...
            >
              <div className="flex flex-col items-start gap-6">
                <div className="flex-1 w-full">
                  ...
                  <a 
                    href="/downloads/repomod-MoreShopItems-1.2.5.zip" 
