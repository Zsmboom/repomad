          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 flex items-center">
                ...
                R.E.P.O. MorePlayers
                <span className="ml-3 text-sm bg-amber-700 px-2 py-1 rounded-full">v1.0.4</span>
              </h1>
              ...
              <div className="flex flex-col items-start gap-6">
                <div className="flex-1 w-full">
                  ...
                  <div className="bg-gray-900/50 p-6 rounded-md border border-amber-500/20 mb-8">
                    <h3 className="text-2xl font-medium mb-4 text-amber-300">How to Configure</h3>
                    ...
                    <div className="bg-gray-950/50 p-4 rounded-md mb-4 text-gray-300 font-mono text-sm">
                      ...
                      <p className="text-amber-300">MaxPlayers = 8</p>
                  ...
                  <div className="mt-16">
                    <RelatedMods currentModId="morePlayers" themeColor="amber" />
                  </div>
                </div>
              </div>
            </motion.div>
