          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 flex items-center">
                <FaRunning className="mr-4 text-amber-400" /> 
                R.E.P.O. MoreStamina
              ...
              <div className="flex flex-col items-start gap-6">
                <div className="flex-1 w-full">
                  ...
                  <div className="bg-gray-900/50 p-6 rounded-md border border-amber-500/20 mb-8">
                    <h3 className="text-2xl font-medium mb-4 text-amber-300">Game Mechanics</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="text-xl font-semibold mb-3 text-amber-200">Stamina Consumption</h4>
                      ...
                      <div>
                        <h4 className="text-xl font-semibold mb-3 text-amber-200">Stamina Recovery</h4>
                        <p className="text-gray-300 mb-4">
                  ...
                  <div className="bg-gray-900/50 p-6 rounded-md border border-amber-500/20 mb-8">
                    ...
                    <div className="bg-amber-900/30 p-4 rounded-md border border-amber-500/20">
                      <h4 className="text-lg font-medium mb-2 text-amber-300">Important Notes:</h4>
                      <ul className="space-y-2 text-gray-300">
                        <li className="flex items-start">
                          <span className="text-amber-400 mr-2">•</span>
                  ...
                  <div className="mt-16">
                    <RelatedMods currentModId="moreStamina" themeColor="amber" />
                  </div>
                </div>
              </div>
            </motion.div>
