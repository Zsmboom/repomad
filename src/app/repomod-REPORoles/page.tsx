          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 flex items-center">
                <FaUserAlt className="mr-4 text-amber-400" /> 
                R.E.P.O. Roles
                <span className="ml-3 text-sm bg-amber-700 px-2 py-1 rounded-full">v1.3.3</span>
              </h1>
              ...
              <div className="flex flex-col items-start gap-6">
                <div className="flex-1 w-full">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div>
                      <h3 className="text-2xl font-medium mb-4 text-amber-300">Available roles:</h3>
                      <ul className="space-y-4">
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Runner</h4>
                          <p>Runs faster than everyone else! Perfect for quick loot runs or escaping danger.</p>
                        </li>
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Tank</h4>
                          <p>Has double HP but moves slower. Ideal for defensive positions and tanking damage.</p>
                        </li>
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Gambler</h4>
                          <p>Gains a random buff and debuff every game. A high-risk, high-reward role!</p>
                        </li>
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Strongman</h4>
                    ...
                    <div>
                      <h3 className="text-2xl font-medium mb-4 text-amber-300">Advanced roles:</h3>
                      <ul className="space-y-4">
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Ranged Looter</h4>
                          <p>Has a lot more range and is a bit stronger. Great for grabbing items from a distance.</p>
                        </li>
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Athletic</h4>
                          <p>Has more stamina and strength and can jump higher. A well-balanced role for versatile play.</p>
                        </li>
                        <li className="bg-gray-900/50 p-4 rounded-md border border-amber-500/20">
                          <h4 className="text-xl font-semibold text-amber-400 mb-2">The Mage</h4>
                  ...
                  <div className="mt-16">
                    <RelatedMods currentModId="repoRoles" themeColor="amber" />
                  </div>
                </div>
              </div>
            </motion.div>
