...
import { FiDownload, FiVideo, FiInfo, FiMusic, FiArrowLeft } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 flex items-center">
                <FiMusic className="mr-3 text-yellow-500" /> 
                LegoGnomes
              </h1>
          ...
          <div className="bg-gray-900/50 p-6 rounded-lg mb-8 border border-yellow-500/20">
            <p className="text-xl text-gray-300 mb-6">
              Enhance your REPO experience with our premium REPO MODS collection. These REPO MODS add exciting new features and customization options to improve your REPO gameplay. All REPO MODS are fully compatible with the latest version of REPO and receive regular updates. Before using mods, you need to install <a href="https://thunderstore.io/c/repo/p/BepInEx/BepInExPack/" className="text-yellow-400 hover:underline" target="_blank" rel="noopener noreferrer">BepInExPack</a> and <a href="https://www.overwolf.com/app/thunderstore-thunderstore_mod_manager" className="text-yellow-400 hover:underline" target="_blank" rel="noopener noreferrer">Thunderstore Mod Manager</a>. For detailed installation instructions, please check our <Link href="/How-to-Install-REPO-Mods" className="text-yellow-400 hover:underline">installation guide</Link>.
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-bold text-yellow-400 mb-4 mt-8 flex items-center">
              <FiInfo className="mr-2" /> Features
            </h2>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2 mt-1">•</span>
                <span><strong className="text-yellow-400">Sound replacement:</strong> Replaces gnome death sounds with the iconic Lego brick breaking sound effect</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2 mt-1">•</span>
                <span><strong className="text-yellow-400">Perfect match:</strong> Syncs perfectly with the gnome's existing death animation where they break into pieces</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-500 mr-2 mt-1">•</span>
                <span><strong className="text-yellow-400">Lightweight:</strong> Minimal performance impact</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-yellow-400 mb-4 mt-8">Compatibility</h2>
            <p className="mb-4">
            ...
            <div className="mt-8 p-4 bg-yellow-900/30 border border-yellow-500/40 rounded-lg">
              <h3 className="text-lg font-semibold mb-2">Installation Instructions</h3>
              <p className="text-sm mb-3">
                1. Install <a href="https://thunderstore.io/c/repo/p/BepInEx/BepInExPack/" className="text-yellow-400 hover:underline" target="_blank" rel="noopener noreferrer">BepInExPack</a> if you haven't already.
              </p>
              <p className="text-sm mb-3">
            ...
            <RelatedMods currentModId="legoGnomes" themeColor="yellow" />
          </div>
        </motion.div>
      </main>
