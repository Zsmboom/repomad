    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <motion.div
          ...
          className="bg-gray-800/70 backdrop-blur-sm rounded-lg p-8 border border-amber-700/50 mb-8"
        >
          <div className="mb-4">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 flex items-center">
                <FiTarget className="mr-3 text-amber-500" /> 
                Enemy Location
              </h1>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                ...
                <span><strong className="text-amber-400">Real-time enemy tracking:</strong> See the approximate positions of enemies within a configurable range.</span>
              </li>
              <li className="flex items-start">
                <span className="text-amber-500 mr-2 mt-1">•</span>
                <span><strong className="text-amber-400">Visual indicators:</strong> Intuitive UI displays that show enemy proximity with directional indicators.</span>
              </li>
              <li className="flex items-start">
                <span className="text-amber-500 mr-2 mt-1">•</span>
                <span><strong className="text-amber-400">Range customization:</strong> Configure the tracking range to suit your playstyle.</span>
              </li>
              <li className="flex items-start">
                <span className="text-amber-500 mr-2 mt-1">•</span>
                <span><strong className="text-amber-400">Multiplayer compatible:</strong> Works perfectly in multiplayer sessions without causing desync.</span>
              </li>
              <li className="flex items-start">
                <span className="text-amber-500 mr-2 mt-1">•</span>
                <span><strong className="text-amber-400">UI customization:</strong> Adjust the appearance and position of tracking indicators.</span>
              </li>
            </ul>
            ...
            <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-semibold text-amber-300 mb-2">v1.0.3 (Latest)</h3>
            ...
            <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-semibold text-amber-300 mb-2">v1.0.2</h3>
              <ul className="space-y-2 pl-4">
            ...
            <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-semibold text-amber-300 mb-2">v1.0.1</h3>
              <ul className="space-y-2 pl-4">
            ...
            <p className="mb-4">
              Enemy Location offers several configuration options that can be adjusted in the <code className="bg-gray-700 px-2 py-1 rounded text-amber-300">config.json</code> file:
            </p>
  ...
  "colorByType": true           // Use different colors for enemy types
            ...
            <div className="mt-12 flex justify-center">
              <Link 
                ...
                className="inline-flex items-center px-8 py-4 bg-amber-700 text-white rounded-md hover:bg-amber-600 transition-colors text-lg"
                download
              >
            ...
            <RelatedMods currentModId="enemyLocation" themeColor="amber" />
          </div>
        </motion.div>
      </main>
